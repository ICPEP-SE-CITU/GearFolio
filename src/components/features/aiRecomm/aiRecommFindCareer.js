...
export default function JobSearchUI() {
  ...
  const renderStars = (rating) => {
    ...
    for (let i = 0; i < 5; i++) {
      stars.push(
        <svg key={i} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill={i < Math.floor(rating) ? "#FFD700" : "none"} stroke="#FFD700" strokeWidth="1" className="mr-1">
  ...
  const renderJobListings = () => {
    return jobListings.map((job) => (
      <div 
        key={job.id} 
        className={`p-3 hover:bg-blue-50 transition-colors duration-150 border-b border-gray-100 cursor-pointer ${selectedJob?.id === job.id ? 'bg-blue-50' : ''}`}
            ...
            <div className="flex-1">
              <div className="flex flex-col">
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="text-md font-semibold text-gray-900">{job.company}</h3>
                ...
                <div className="flex flex-wrap mt-2">
                  {job.skills.map((skill, index) => (
                    <span key={index} className="text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded-full mr-1 mb-1">
                      {skill}
                    </span>
                  ))}
                </div>
    ...
    <div className="flex w-full h-screen bg-gray-50">
      ...
      <div className="fixed top-0 left-0 right-0 bg-white py-3 px-4 shadow-sm z-20 md:hidden">
        <div className="flex justify-between items-center">
          <button 
            className={`px-4 py-1 text-sm font-medium rounded-full ${view === 'list' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700'}`}
            onClick={() => setView('list')}
          >
            List
          </button>
          <button 
            className={`px-4 py-1 text-sm font-medium rounded-full ${view === 'map' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700'}`}
            onClick={() => setView('map')}
          >
            Map
          </button>
      ...
      <div className={`${view === 'map' ? 'hidden' : 'block'} md:block w-full md:w-96 bg-white shadow-md rounded-lg overflow-hidden m-2 flex flex-col mt-12 md:mt-2`}>
        {/* Search Bar */}
      ...
      <div className={`${view === 'list' ? 'hidden' : 'block'} md:block flex-1 bg-white m-2 rounded-lg overflow-hidden shadow-md relative mt-12 md:mt-2`}>
        {selectedJob ? (
            ...
            <div className="flex-1 overflow-y-auto p-4">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <div className="flex items-center mt-1">
                    ...
                    <span className="text-gray-700 ml-2">{selectedJob.rating.toFixed(1)}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 rounded-lg p-4 mb-6">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-md font-semibold text-gray-900">{selectedJob.salary}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Job Type</p>
                    <p className="text-md font-semibold text-gray-900">{selectedJob.type}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Location</p>
                    <p className="text-md font-semibold text-gray-900">{selectedJob.distance} away</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Posted</p>
                    <p className="text-md font-semibold text-gray-900">{selectedJob.posted}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700 mb-4">
                  We are looking for an experienced {selectedJob.title} to join our team. The ideal candidate will have a strong background in artificial intelligence and machine learning.
                </p>
                <p className="text-gray-700 mb-4">
                  You&apos;ll work on cutting-edge AI projects and collaborate with a talented team of engineers and researchers to develop innovative solutions.
                </p>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap">
                  {selectedJob.skills.map((skill, index) => (
                    <span key={index} className="text-sm bg-gray-100 text-gray-700 px-3 py-1 rounded-full mr-2 mb-2">
                      {skill}
                    </span>
                  ))}
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700 mb-4">
                  {selectedJob.company} is a leading technology company focused on artificial intelligence and machine learning solutions.
                </p>
                <p className="text-gray-700">
                  We are dedicated to creating innovative AI technologies that solve real-world problems.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 border-t border-gray-100">
              <div className="flex space-x-4">
                ...
                <button className="flex flex-col items-center justify-center w-12 h-12 rounded-full bg-blue-100 hover:bg-blue-200 transition-colors duration-150">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4A56E2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <>
            ...
            <div className="absolute top-4 left-0 right-0 flex justify-center z-10">
              <div className="relative w-96">
                ...
                {mapSearchQuery && (
                  <div className="absolute right-3 top-3">
                    <button onClick={() => setMapSearchQuery('')} className="text-gray-400 hover:text-gray-600">
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <line x1="18" y1="6" x2="6" y2="18"></line>
                        <line x1="6" y1="6" x2="18" y2="18"></line>
                      </svg>
            ...
            <div className="w-full h-full bg-white flex flex-col items-center justify-center">
              <div className="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#4A56E2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mx-auto mb-4">
                  <polygon points="1 6 1 22 8 18 16 22 23 18 23 2 16 6 8 2 1 6"></polygon>
                  <line x1="8" y1="2" x2="8" y2="18"></line>
                  <line x1="16" y1="6" x2="16" y2="22"></line>
                </svg>
                <p className="text-gray-700 mb-2">Map View</p>
                <p className="text-sm text-gray-500">Select a location to see job listings</p>
              </div>
            </div>
