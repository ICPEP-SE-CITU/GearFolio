              ...
              <nav className="bg-white/70 max-w-[1800px] mx-auto text-gray-800 rounded-[20px] p-5 flex items-center justify-between">
                ...
                <div>
                  <button 
                    ...
                    className="px-[40px] text-xl ml-[20px] font-regular hover:text-blue-600 transition-colors"
                  >
                    Sign up
                  </button>
                  <button
              ...
              <div className="relative z-10 text-gray-800 p-10 rounded-lg max-w-[1600px] mx-auto">
                ...
                <div className="flex justify-center mt-8">
                  <button
                    ...
                    className="bg-[#2E8BC0] hover:bg-[#0C7AB9] text-white px-8 py-4 rounded-md flex items-center transition-colors text-xl font-medium"
                  >
                    Try GEARFOLIO
