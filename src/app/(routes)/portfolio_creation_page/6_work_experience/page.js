...
const [progress, setProgress] = useState(69); // Local state for progress animation
const [targetProgress, setTargetProgress] = useState(69); // Local state for progress target
const [isAnimating, setIsAnimating] = useState(false); // Local state for animation control (assumed)
